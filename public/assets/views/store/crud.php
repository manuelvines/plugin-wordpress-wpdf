    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                    ...
                    <form id="crud_stores_form_update"  action="" method="POST">
                                <input type="hidden" name="action" value="update-store">
                                <input type="hidden" name="_wpnonce" value="<?php echo wp_create_nonce('update-store'); ?>">
                                        ...
                                        <td >
                                          ...
                                          <td>
                                            ...
                                            <form class="crud_stores_form_destroy"  action="" method="POST">
                                              <input type="text" name="action" value="destroy-store">
                                              <input type="text" name="store_id"  value="<?php echo $store->id ?>">
                                              <input type="text" name="_wpnonce" value="<?php echo wp_create_nonce('destroy-store'); ?>">
